    ...
    @foreach($projects as $project)
      <div class="card @if($project->is_featured) featured @endif" 
        ...
        <div class="cardContent">
          ...
          <p class="shortDescription">{{ Str::limit($project->description, 120) }}</p>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  projects.forEach(project => {
    ...
    function goToSlide(index) {
      ...
      images[currentIndex].style.transform = 'translateX(-20px)';
    ...
    item.addEventListener('click', function() {
      ...
      projectItems.forEach(project => {
        ...
        if (filterValue === 'all' || category === filterValue) {
          ...
          project.style.animation = 'fadeIn 0.6s ease forwards';
        } else {
